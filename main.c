...
int WINAPI WinMain(HINSTANCE hIns,HINSTANCE hInstanciaPrevia,LPSTR lpCmdLinea,int nCmdShow){
    ...
    clase.hbrBackground =CreateSolidBrush( RGB(225,139,114));
    if(!RegisterClassEx(&clase)){
        MessageBox( NULL,"No se pudo ejecutar la aplicacion","Error",MB_ICONERROR);
        return EXIT_FAILURE;
    }
    ventana = CreateWindowEx(0,"IdentificadorVentana","Calculadora_Cardoso_Fernandez",WS_OVERLAPPEDWINDOW |WS_SYSMENU,400,80,580,630,HWND_DESKTOP,NULL,hIns,NULL);
    CreateWindowW(L"Static",L"Ingrese un numero 1: ",WS_VISIBLE | WS_CHILD , 90,100,150,20,ventana,NULL,hIns,NULL);
    ...
    CreateWindowW(L"Static",L"Ingrese un numero 2: ",WS_VISIBLE | WS_CHILD  , 90,150,150,20,ventana,NULL,hIns,NULL);
    ...
    CreateWindowEx(0,"BUTTON","Exit",BS_CENTER|WS_VISIBLE|WS_CHILD,400,550,150,30,ventana,(HMENU)ID_BTNSALIR,NULL,NULL);
    CreateWindowEx(0,"BUTTON","=",BS_CENTER|WS_VISIBLE|WS_CHILD,260,250,150,30,ventana,(HMENU)ID_RESOLVER,hIns,NULL);
                ...
                case WM_COMMAND:{
                   switch(LOWORD(wParam)){
                        ...
                        case ID_RESOLVER:{
                            ...
                            }else  if(strcmp(respuestaR,"-")==0){
                                res = nmr1 - nmr2;
                                itoa(res,respuestFinal,10);
                                CreateWindow("STATIC",respuestFinal,ES_CENTER|WS_CHILD|WS_VISIBLE,450,123,80,25,hwnd,NULL,NULL,NULL);
                            }else  if(strcmp(respuestaR,"X")==0){
                                res = nmr1 * nmr2;
                                itoa(res,respuestFinal,10);
                                CreateWindow("STATIC",respuestFinal,ES_CENTER|WS_CHILD|WS_VISIBLE,450,123,80,25,hwnd,NULL,NULL,NULL);
                            } if(strcmp(respuestaR,"/")==0){
